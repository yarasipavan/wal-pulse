  ...
  return (
    <>
      <form className=" w-100  mx-auto mb-2" onSubmit={handleSubmit(onSubmit)}>
          ...
          <div className="col-12 col-sm-6 col-md-4 col-lg-3">
            ...
            <div className="mt-3">
              ...
              {errors.account_manager_id?.type === "required" && (
                <p className="text-danger">Please select the account manager</p>
              )}
            </div>
          </div>
          ...
          <div className="col-12 col-sm-6 col-md-4 col-lg-3">
            ...
            <div className="mt-3">
              ...
              {errors.project_manager_id?.type === "required" && (
                <p className="text-danger">Please select the project manager</p>
              )}
            </div>
          </div>
          <div className="col-12 col-sm-6 col-md-4 col-lg-3">
        ...
        <div className="mt-4 ">
          <button className="btn btn-wal d-block mx-auto  ">Add Project</button>
        </div>
      </form>
